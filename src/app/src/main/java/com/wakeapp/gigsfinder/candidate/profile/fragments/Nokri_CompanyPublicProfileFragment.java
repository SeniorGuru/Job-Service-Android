...
import com.wakeapp.gigsfinder.candidate.profile.model.Nokri_RecentJobsModel;
...
public class Nokri_CompanyPublicProfileFragment extends Fragment implements TabLayout.OnTabSelectedListener,View.OnClickListener{
    ...
    private void nokri_setupViewPager(){
        ...
        companyDetailFragment = new Nokri_CompanyDetailFragment(purchased);
        companyDetailFragment.setData(profileDetailTextView,aboutMeTextView,aboutMeDataTextView,descriptionModelList);
