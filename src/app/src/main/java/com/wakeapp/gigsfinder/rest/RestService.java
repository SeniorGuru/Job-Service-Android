package com.wakeapp.gigsfinder.rest;
...
public interface RestService {
    ...
    @Multipart
    @POST("candidate/audio_upload")
    Call<ResponseBody> postUploadAudio(@Part MultipartBody.Part image, @HeaderMap Map<String, String> headers);
