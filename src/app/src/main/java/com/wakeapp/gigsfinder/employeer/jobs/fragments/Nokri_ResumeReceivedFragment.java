...
import com.wakeapp.gigsfinder.employeer.jobs.adapters.Nokri_ReceivedResumeAdapter;
...
public class Nokri_ResumeReceivedFragment extends Fragment implements View.OnClickListener,View.OnFocusChangeListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
       ...
       nokri_filterReceivedResumes("0", false);
...
//        alertImage = getView().findViewById(R.id.alert_message);
