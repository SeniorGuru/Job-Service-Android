package com.wakeapp.gigsfinder.employeer.payment.fragments;
...
import com.wakeapp.gigsfinder.employeer.payment.activities.Nokri_InAppPurchaseActivity;
import com.wakeapp.gigsfinder.employeer.payment.activities.Nokri_StripePaymentActivity;
import com.wakeapp.gigsfinder.employeer.payment.activities.Nokri_ThankYouActivity;
import com.wakeapp.gigsfinder.employeer.payment.models.Nokri_InAppPurchaseModel;
import com.wakeapp.gigsfinder.employeer.payment.models.Nokri_PricingModel;
...
import com.wakeapp.gigsfinder.custom.CustomViewPager;
...
toolbarTitleTextView = getActivity().findViewById(R.id.toolbar);
        ...
        myCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> responseObject) {
                if(responseObject.isSuccessful()){
                    ...
                    Log.d("data",response.getJSONObject("data").toString());
//                         if(data.getBoolean("is_paypal_key"))
//                         {
//                             paypalJson = data.getJSONObject("paypal");
//                             Log.d("paypaljson",paypalJson.toString());
//
//                         }
...
//                         }
                      ...
                      toolbarTitleTextView.setTitle(response.getJSONObject("extra").getString("page_title"));
...
//
                        for(int i = 0;i<produnctsArray.length();i++) {
                            ...
                            } else if (object.getString("is_free").equals("1")) {
                            ...
                            emptyTextView.setText("No products were added");
//                            Toast.makeText(getApplicationContext(), "No products were added", Toast.LENGTH_SHORT).show();
                        }}
                ...
                case "app_inapp":
                    ...
                    if(!inAppPurchaseModel.getAndroidPurchaseCode().trim().isEmpty())
                    {
                        if(inAppPurchaseModel.isInAppOn()) {
                            ...
                            Log.d("inapp", inAppPurchaseModel.getProductAndroidInApp());
